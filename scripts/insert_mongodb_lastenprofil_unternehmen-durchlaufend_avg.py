...
db_name = 'pre_ETL'
collection_name = 'bdew_lastenprofil_unternehmen-durchlaufend_avg'
...
filename = 'bdew_lastenprofil_unternehmen-durchlaufend_avg.csv'  # Adjust the filename as necessary
